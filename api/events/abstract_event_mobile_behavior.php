...
abstract class AbstractEvent_MobileBehavior extends Extension_DevblocksEvent {
	...
	function generateSampleEventModel(Model_TriggerEvent $trigger, $worker_id=null) {
		if(empty($worker_id) && (false !== ($active_worker = CerberusApplication::getActiveWorker())))
			$worker_id = $active_worker->id;
		elseif(null != ($worker = DAO_Worker::random()))
			$worker_id = $worker->id;
