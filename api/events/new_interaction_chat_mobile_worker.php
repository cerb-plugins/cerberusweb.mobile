...
class Event_NewInteractionChatMobileWorker extends Extension_DevblocksEvent {
	const ID = 'event.interaction.chat.mobile.worker';
	...
	function renderActionExtension($token, $trigger, $params=array(), $seq=null) {
		...
		switch($token) {
			...
			case 'switch_behavior':
				$tpl->display('devblocks:cerberusweb.mobile::bots/action_switch_behavior.tpl');
				break;
		}
